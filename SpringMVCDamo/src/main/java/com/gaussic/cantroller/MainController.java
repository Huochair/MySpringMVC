...
import com.gaussic.dao.userSeBlog;
...
//             ) {
//            userSeBlog userSeBlog = new userSeBlog();
//            List<BlogEntity> dx = userSeBlog.queryById(us.getId());
//            us.setBlogsById(dx);
...
// 例如：访问 localhost:8080/admin/users/show/1 ，将匹配 id = 1
    ...
    @RequestMapping(value = "/admin/indexscdf", method = RequestMethod.GET)
    public ModelAndView showBlog(String tt) {
        String x = "fsadfasdfsadf";

        System.out.println("职位：：：：：：：：：：：："+tt);
        ModelAndView nao = new ModelAndView("admin/indexs","x",x);
        return nao;
    }
}