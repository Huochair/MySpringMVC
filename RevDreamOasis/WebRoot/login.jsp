                ...
                <div id="middle" margin:20px auto;>
                    <form action="login" method="post">
                        <ul style="text-align: center;">
                            ...
                            <li style="font-size: 20px"> 我们来到你的地方，只为与你一同欢笑</li></br></br>
                            <li><input class="name" name="username" placeholder="请输入手机号或邮箱"></li></br>
                            <li><input type="password" name="password" class="pwd" placeholder="请输入密码"></li></br>
                            <li id="verifyCode" style="display: block;">
                                &nbsp;&nbsp;&nbsp;<input id="valid" name="rand" placeholder="请输入验证码" maxlength="4">
                                <span id="validcode">
                                    <img id="verifyCodePic" id="img_captcha" src="/img/jcaptcha.jpg">
                                </span>
                                <span id="images1/img1.jpg">
                                    换一张
                                </span>
                            </li></br>
                            <li><button id="logIn" style="font-size: 20px">立即登录</button></li>
                            <li><span id="err" style="display: inline-block;">密码错误</span></li>
                            <li><a>忘记密码？</a>&nbsp;&nbsp;<a href="register.jsp">立即注册&gt;&gt;</a></li>
                        </ul>
                    </form>
                </div>
            </td>
